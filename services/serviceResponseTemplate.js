...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_MOVIES] = async (
  sender_psid,
  text_response,
  response
) => {
...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_MOVIES_PLACE] = async (
  sender_psid,
  text_response,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_template_movies_place (
      response,
      context
    );
...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_MOVIES_GENRE] = async (
  sender_psid,
  text_response,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_template_movies_genre (
      response,
      context
    );
...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_MOVIES_GENRE_PLACE] = async (
  sender_psid,
  text_response,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_template_movies_genre_place (
      response,
      context
    );
 ...
 * 
 */
exports[constants.templates.GENERIC_TEMPLATE_SCHEDULE] = async (
  sender_psid,
  text_response,
  response
) => {
...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_NEW_RELEASES] = async (
  sender_psid,
  text_response,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_template_new_releases (
      response,
      context
    );
...
*
*/
exports[constants.templates.GENERIC_TEMPLATE_NEW_RELEASES_MOVIE] = async (
  sender_psid,
  text_response,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_template_new_releases_movie (
      response,
      context
    );
