...
*
*/
exports[constants.quickReplies.QUICK_REPLIES_LOCATIONS] = async (
  sender_psid,
  response
) => {
  try {
    ...
    if (context.data) {
      ...
      throw new Error ('No property data in context');
    }

    response = repositoryContainer.get_quickReplies_location (
      response,
      context
    );
...
*
*/
exports[constants.quickReplies.QUICK_REPLIES_DATE] = async (
  sender_psid,
  response
) => {
  try {
...
*
*/
exports[constants.quickReplies.QUICK_REPLIES_DATE_PLACE] = async (
  sender_psid,
  response
) => {
  try {
    ...
    response = repositoryContainer.get_quickReplies_date_place (
      response,
      context
    );
